...
if __name__ == "__main__":
    ...
    parser.add_argument("from_cwd", help="Source path of your directory to be saved", default=True, type=bool)
    ...
    # Copy the content from cwd to the target path
    for item in current_directory.iterdir():
        dest = new_root_path / item.name
        if item.is_dir():
